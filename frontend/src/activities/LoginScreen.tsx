    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-6 font-sans relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10 transition-all duration-700 animate-in fade-in slide-in-from-bottom-8">
                <div className="bg-white/5 backdrop-blur-2xl p-10 rounded-2xl border border-white/10 shadow-2xl shadow-black/40">
                    <div className="text-center mb-10">
                        <div className="w-16 h-16 bg-indigo-600 rounded-xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-indigo-500/20 rotate-3">
                    ...
                    <div className="space-y-4">
                        <Link to="/home" className="block">
                            <Button className="w-full h-16 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-heading font-bold text-lg shadow-xl shadow-indigo-500/10 transition-all active:scale-[0.98]">
                                Get Started
                            </Button>
                        </Link>
                        <Button variant="secondary" className="w-full h-16 rounded-xl bg-white/5 hover:bg-white/10 text-white border-white/5 font-heading font-bold text-lg transition-all active:scale-[0.98]">
                            View Sandbox
                        </Button>
                    </div>
