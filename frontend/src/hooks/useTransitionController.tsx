...
const ROUTE_MAP: Record<string, TransitionMessage> = {
    ...
    '/workbench': { primary: 'INITIALIZING LAB ENVIRONMENT', level: 1 },
    '/cpu-lab': { primary: 'LOADING CPU ARCHITECTURE', level: 2 },
    '/eda-playground': { primary: 'SYNCING VERILOG WORKSPACE', level: 3 },
    '/hw-leetcode': { primary: 'ACCESSING CHALLENGE MATRIX', level: 2 },
    '/fsm': { primary: 'INITIALIZING STATE DYNAMICS', level: 2 },
