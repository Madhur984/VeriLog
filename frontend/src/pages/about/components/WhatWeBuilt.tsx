    ...
    <SectionWrapper id="what-we-built" className="bg-[#07080A] border-t border-white/[0.03]">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="relative space-y-8 pl-8 md:pl-12">
          ...
          <div className="absolute left-[16px] md:left-[24px] top-6 bottom-6 w-0.5 border-l border-dashed border-white/10 pointer-events-none" />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative bg-[#0D0F12] border border-white/[0.08] border-l-4 border-l-emerald-400 rounded-xl p-8 hover:border-slate-800 transition-colors"
          >
            {/* Dot indicator on vertical line */}
            <div className="absolute left-[-29px] md:left-[-37px] top-[34px] w-3 h-3 rounded-full bg-emerald-400 border-4 border-observatory-bg" />
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="relative bg-[#0D0F12] border border-white/[0.08] border-l-4 border-l-amber-400 rounded-xl p-8 hover:border-slate-800 transition-colors"
          >
            {/* Dot indicator on vertical line */}
            <div className="absolute left-[-29px] md:left-[-37px] top-[34px] w-3 h-3 rounded-full bg-amber-400 border-4 border-observatory-bg" />
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="relative bg-[#0D0F12] border border-white/[0.08] border-l-4 border-l-cyan-400 rounded-xl p-8 hover:border-slate-800 transition-colors"
          >
            {/* Dot indicator on vertical line */}
            <div className="absolute left-[-29px] md:left-[-37px] top-[34px] w-3 h-3 rounded-full bg-cyan-400 border-4 border-observatory-bg" />
