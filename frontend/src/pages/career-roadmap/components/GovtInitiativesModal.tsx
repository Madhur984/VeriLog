          ...
          {govtInitiatives.map((scheme) => (
            <article key={scheme.acronym} className="p-5 sm:p-6 border border-ghost-trace bg-matte-obsidian/30 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row gap-6 relative z-10">
                <div className="flex-1 space-y-4"><div className="flex items-center gap-3"><h3 className="text-base sm:text-lg font-mono font-bold text-text-main">{scheme.name}</h3><span className="px-2 py-0.5 bg-plasma-cyan text-matte-obsidian font-mono text-[10px] font-bold rounded uppercase">{scheme.status}</span></div>
