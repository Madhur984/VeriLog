    ...
    <SectionWrapper id="intel" className="bg-observatory-surface">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-12">
          ...
          <button className="px-8 py-3 bg-bg-elev/40 border border-border-soft rounded-full text-[10px] font-mono text-slate-400 uppercase tracking-widest hover:text-text-main hover:border-border-soft/80 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {initiatives.map((item) => (
            <motion.div
              key={item.title}
              whileHover={{ y: -8 }}
              className="p-8 bg-observatory-bg border border-border-soft rounded-2xl space-y-6 group cursor-pointer hover:border-cyan-400/30 transition-all"
            >
              <div className="flex justify-between items-start">
                <div className="px-2 py-0.5 bg-bg-elev/40 border border-border-soft rounded text-[9px] font-mono text-slate-500 uppercase tracking-widest group-hover:text-cyan-400 transition-colors">
                  {item.type}
                </div>
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-text-main uppercase tracking-tight group-hover:text-cyan-400 transition-colors">
                  {item.title}
                </h3>
