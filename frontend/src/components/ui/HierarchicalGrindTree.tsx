...
const ROOT_NODES: RootNode[] = [
  ...
  },
  {
    ...
    status: 'locked',
    children: [
      { id: 'r4c1', label: 'AND / OR / NOT',    pct: 0, color: '#fbbf24', icon: '∧', locked: true },
      { id: 'r4c2', label: 'NAND / NOR',        pct: 0, color: '#f59e0b', icon: '↑', locked: true },
      { id: 'r4c3', label: 'XOR / XNOR',        pct: 0, color: '#d97706', icon: '⊕', locked: true },
      { id: 'r4c4', label: 'Universal Gates',   pct: 0, color: '#fde68a', icon: '⊗', locked: true },
      { id: 'r4c5', label: 'Gate Minimization', pct: 0, color: '#fef3c7', icon: '▣', locked: true },
    ],
  },
  {
    id: 'r5',
    ...
    status: 'locked',
    children: [
      { id: 'r5c1', label: '2-Variable Maps',   pct: 0, color: '#fb7185', icon: '▣', locked: true },
      { id: 'r5c2', label: '3-Variable Maps',   pct: 0, color: '#f43f5e', icon: '▤', locked: true },
      { id: 'r5c3', label: '4-Variable Maps',   pct: 0, color: '#e11d48', icon: '▥', locked: true },
      { id: 'r5c4', label: "Don't Care Terms",  pct: 0, color: '#fda4af', icon: '⊘', locked: true },
      { id: 'r5c5', label: 'SOP / POS Forms',   pct: 0, color: '#fecdd3', icon: 'Σ', locked: true },
    ],
  },
  {
    id: 'r6',
