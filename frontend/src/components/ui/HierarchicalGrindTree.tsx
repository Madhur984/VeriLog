...
const ROOT_NODES: RootNode[] = [
  {
    id: 'r1', label: 'Signal Return', fullLabel: 'A Signal Must Return', pct: 0, icon: '〜',
    color: ['#0369a1', '#2dd4bf'], glow: '#2dd4bf', route: '/module/1', status: 'done',
    children: [
      { id: 'r1c1', label: 'Voltage Levels',    pct: 100, color: '#2dd4bf', icon: '⚡', locked: false },
      { id: 'r1c2', label: 'Current Flow',      pct: 100, color: '#38bdf8', icon: '↺',  locked: false },
      { id: 'r1c3', label: 'Ground Ref',        pct: 100, color: '#0ea5e9', icon: '⏚',  locked: false },
      { id: 'r1c4', label: 'Signal Integrity',  pct: 80,  color: '#0284c7', icon: '≋',  locked: false },
      { id: 'r1c5', label: 'Probe Techniques',  pct: 60,  color: '#bae6fd', icon: '🔍', locked: false },
    ],
  },
  {
    id: 'r2', label: 'Discrete', fullLabel: 'Continuous vs Discrete', pct: 0, icon: '⊞',
    color: ['#701a75', '#f472b6'], glow: '#f472b6', route: '/module/2', status: 'done',
    children: [
      { id: 'r2c1', label: 'Analog Signals',     pct: 100, color: '#f472b6', icon: '∿',  locked: false },
      { id: 'r2c2', label: 'Sampling Theorem',   pct: 85,  color: '#d946ef', icon: '≈',  locked: false },
      { id: 'r2c3', label: 'Quantization',       pct: 70,  color: '#c026d3', icon: '◫',  locked: false },
      { id: 'r2c4', label: 'Nyquist Rate',       pct: 50,  color: '#a21caf', icon: '∫',  locked: false },
      { id: 'r2c5', label: 'ADC / DAC',          pct: 30,  color: '#fbcfe8', icon: '⇄',  locked: false },
    ],
  },
  {
    id: 'r3', label: 'Binary', fullLabel: 'Binary Awakening', pct: 0, icon: '⊕',
    color: ['#064e3b', '#a4d620'], glow: '#a4d620', route: '/module/3', status: 'active',
    children: [
      { id: 'r3c1', label: 'Number Systems',    pct: 100, color: '#a4d620', icon: '01',  locked: false },
      { id: 'r3c2', label: 'Binary Arithmetic', pct: 90,  color: '#84cc16', icon: '+',   locked: false },
      { id: 'r3c3', label: "Two's Complement",  pct: 70,  color: '#65a30d', icon: '±',   locked: false },
      { id: 'r3c4', label: 'Hex & Octal',       pct: 55,  color: '#4d7c0f', icon: '0x',  locked: false },
      { id: 'r3c5', label: 'BCD Encoding',      pct: 20,  color: '#16a34a', icon: '◧',   locked: false },
      { id: 'r3c6', label: 'Gray Code',         pct: 0,   color: '#86efac', icon: '≡',   locked: true  },
    ],
  },
  {
    id: 'r4', label: 'Logic Gates', fullLabel: 'Logic Gates', pct: 0, icon: '⊃',
    color: ['#7c2d12', '#fde047'], glow: '#fde047', route: '/module/4', status: 'active',
    children: [
      { id: 'r4c1', label: 'AND / OR / NOT',    pct: 0, color: '#fde047', icon: '∧', locked: false },
      { id: 'r4c2', label: 'NAND / NOR',        pct: 0, color: '#facc15', icon: '↑', locked: false },
      { id: 'r4c3', label: 'XOR / XNOR',        pct: 0, color: '#eab308', icon: '⊕', locked: false },
      { id: 'r4c4', label: 'Universal Gates',   pct: 0, color: '#ca8a04', icon: '⊗', locked: false },
      { id: 'r4c5', label: 'Gate Minimization', pct: 0, color: '#a16207', icon: '▣', locked: false },
    ],
  },
  {
    id: 'r5', label: 'K-Maps', fullLabel: 'K-Maps', pct: 0, icon: '▦',
    color: ['#881337', '#fda4af'], glow: '#fda4af', route: '/kmap', status: 'active',
    children: [
      { id: 'r5c1', label: '2-Variable Maps',   pct: 0, color: '#fda4af', icon: '▣', locked: false },
      { id: 'r5c2', label: '3-Variable Maps',   pct: 0, color: '#fb7185', icon: '▤', locked: false },
      { id: 'r5c3', label: '4-Variable Maps',   pct: 0, color: '#f43f5e', icon: '▥', locked: false },
      { id: 'r5c4', label: "Don't Care Terms",  pct: 0, color: '#e11d48', icon: '⊘', locked: false },
      { id: 'r5c5', label: 'SOP / POS Forms',   pct: 0, color: '#be123c', icon: 'Σ', locked: false },
    ],
  },
  {
    id: 'r6', label: 'Verilog', fullLabel: 'Verilog Basics', pct: 0, icon: '≡',
    color: ['#1e3a8a', '#93c5fd'], glow: '#93c5fd', route: '/verilog', status: 'locked',
    children: [
      { id: 'r6c1', label: 'Module Syntax',     pct: 0, color: '#93c5fd', icon: '{', locked: true },
      { id: 'r6c2', label: 'Wire & Reg',        pct: 0, color: '#60a5fa', icon: '≋', locked: true },
      { id: 'r6c3', label: 'Always Blocks',     pct: 0, color: '#3b82f6', icon: '⟳', locked: true },
      { id: 'r6c4', label: 'Testbenches',       pct: 0, color: '#2563eb', icon: '⊡', locked: true },
      { id: 'r6c5', label: 'State Machines',    pct: 0, color: '#1d4ed8', icon: '⬡', locked: true },
      { id: 'r6c6', label: 'Simulation',        pct: 0, color: '#1e40af', icon: '▶', locked: true },
    ],
  },
];
