...
const L6_PATHS: PathOption[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      {
        id: 'm5dsd', label: 'Circuit Realisation · Wing X', subtitle: 'L5 · TT · K-MAP · GATES', route: '/dsd/3/cover',
        submodules: [
          { id: 'm5dsd0',  label: 'Cover · The Secret of Wing X',  route: '/dsd/3/cover'     },
          { id: 'm5dsd1',  label: 'Video · K-Map → Circuit',       route: '/dsd/3/video'     },
          { id: 'm5dsd2',  label: 'An Undocumented Wing',          route: '/dsd/3/hidden'    },
          { id: 'm5dsd3',  label: 'Three Doors · A · B · C',       route: '/dsd/3/variables' },
          { id: 'm5dsd4',  label: 'Security Dossier · Gates',      route: '/dsd/3/dossier'   },
          { id: 'm5dsd5',  label: 'Universal Gates · NAND/NOR',    route: '/dsd/3/universal' },
          { id: 'm5dsd6',  label: 'The Gauntlet · Live Signal',    route: '/dsd/3/gauntlet'  },
          { id: 'm5dsd7',  label: 'Final Chokepoint',              route: '/dsd/3/choke'     },
          { id: 'm5dsd8',  label: 'Trace Back · Path 1 / 2',       route: '/dsd/3/trace'     },
          { id: 'm5dsd9',  label: 'Master Equation · SOP',         route: '/dsd/3/master'    },
          { id: 'm5dsd10', label: 'Boolean Algebra Lab',           route: '/dsd/3/algebra'   },
          { id: 'm5dsd11', label: 'Truth Table Lab',               route: '/dsd/3/truth'     },
          { id: 'm5dsd12', label: 'Canonical SOP & POS',           route: '/dsd/3/canonical' },
          { id: 'm5dsd13', label: 'Truth Table → K-Map',           route: '/dsd/3/kmap'      },
          { id: 'm5dsd14', label: "Don't Care Loophole",           route: '/dsd/3/dontcare'  },
          { id: 'm5dsd15', label: '4-Variable Boss Walkthrough',   route: '/dsd/3/boss4'     },
          { id: 'm5dsd16', label: 'Building the Circuit · Library',route: '/dsd/3/forward'   },
          { id: 'm5dsd17', label: 'Three Faces of One Truth',      route: '/dsd/3/faces'     },
          { id: 'm5dsd18', label: 'Case Closed',                   route: '/dsd/3/closed'    },
          { id: 'm5dsd19', label: 'Practice Arena',                route: '/dsd/3/practice'  },
        ],
      },
    ],
  },
