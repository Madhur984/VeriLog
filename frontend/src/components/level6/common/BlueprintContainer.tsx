...
export const BlueprintContainer: React.FC<{ children: React.ReactNode, className?: string }> = ({ children, className = "" }) => {
  return (
    <div className={`relative w-full min-h-[60vh] flex flex-col items-center justify-center p-8 md:p-12 overflow-hidden bg-bg-base rounded-[60px] md:rounded-[80px] border border-border-soft shadow-neo ${className}`}>
