...
export const Sidebar = () => {
    return (
        <div className="flex flex-col h-full p-4 gap-4 bg-card border-r-2 border-border w-[88px] xl:w-[256px] fixed left-0 top-0 z-50">
            {/* Logo */}
            ...
            <nav className="flex flex-col gap-2">
                <SidebarItem icon={Home} label="Dashboard" to="/portal" />
