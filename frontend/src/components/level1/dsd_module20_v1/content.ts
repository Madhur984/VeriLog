  ...
  scenes: [
    ...
    },
    {
      ...
      theoryEN: [
        ...
        "Overlay all three terms and they light up for every single value from 10 to 19, and - this is the key part - they stay completely dark for 0 through 9. The Z8.Z2 term is what plugs the otherwise-missed gap at 10 and 11, so the union is precisely the forbidden range and nothing more.",
