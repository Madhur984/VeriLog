      ...
      <div className="grid lg:grid-cols-[1.4fr_1fr] gap-8">
        <div className="space-y-4">
          ...
          >
            ...
            <div className="absolute top-3 left-3 px-3 py-1 rounded-full bg-black/60 backdrop-blur border border-sky-400/30 font-mono text-[10px] uppercase tracking-widest text-sky-300 flex items-center gap-2">
