  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 py-4">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        >
          <img src="/images/sketchbook/p04.png" alt="Path of Joy — selecting the happy rows" className="w-full block" />
        ...
        <motion.div
          ...
          className="rounded-3xl overflow-hidden border border-white/10" style={{ background: '#fef9f0' }}
        >
          <img src="/images/sketchbook/p05.png" alt="Anatomy of a minterm — puzzle metaphor" className="w-full block" />
          <div className="px-4 py-2 text-[10px] font-mono uppercase tracking-widest text-slate-700 bg-white/60">
