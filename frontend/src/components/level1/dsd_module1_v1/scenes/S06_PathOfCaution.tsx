    ...
    <div className="max-w-6xl mx-auto space-y-12 py-4">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        <div className="rounded-3xl overflow-hidden border border-white/10" style={{ background: '#fef9f0' }}>
          <img loading="lazy" decoding="async" src="/images/sketchbook/p07.webp" alt="Path of Caution - targeting the zeros" className="w-full block" />
        ...
        <div className="rounded-3xl overflow-hidden border border-white/10" style={{ background: '#fef9f0' }}>
          <img loading="lazy" decoding="async" src="/images/sketchbook/p08.webp" alt="Anatomy of a maxterm - barricade metaphor" className="w-full block" />
          <div className="px-4 py-2 text-[10px] font-mono uppercase tracking-widest text-slate-700 bg-white/60">
