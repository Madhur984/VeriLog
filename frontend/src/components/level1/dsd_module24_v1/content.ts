...
export const CONTENT = ({
  ...
  scenes: [
    ...
    },
    {
      ...
      theoryEN: [
        "The simple encoder is neat, but it only works while the one-hot promise holds. Break that promise and it betrays you in two distinct ways. Both flaws come straight from the fact that the outputs are just ORs of inputs, with no logic policing how many inputs are active.",
    ...
    },
    {
      ...
      theoryEN: [
        ...
        "Finally the all-zero row, 0000: no input is active, so the address bits are don't-care (the X's on Y1 Y0) and, importantly, V = 0. This is the single row that distinguishes 'no vote' (00 with V = 0) from 'D0 won' (00 with V = 1). Without V those two situations would be indistinguishable - exactly the zero-active flaw.",
