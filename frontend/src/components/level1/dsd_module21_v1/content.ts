...
export const CONTENT: SubContent = {
  ...
  scenes: [
    ...
    },
    {
      ...
      theoryEN: [
        ...
        "Step four, recognise the result. A'.B + A.B' is the textbook sum-of-products for exclusive-OR, that is Y = A xor B exactly. The MUX, with select lines carrying A and B and the four constants 0,1,1,0 parked on its tracks, behaves identically to an XOR gate. You just synthesised XOR from a lookup table - the same trick an FPGA uses to become any circuit you program into it."
      ],
      theoryHI: [
    ...
    },
    {
      ...
      theoryEN: [
        "Now stop reading and build one. Everything in this module collapses to a tiny pile of gates you can wire yourself: a 4-to-1 multiplexer is just two inverters, four 3-input AND gates and one 4-input OR gate, exactly 7 gates realising Y = S1'.S0'.D0 + S1'.S0.D1 + S1.S0'.D2 + S1.S0.D3.",
    ...
    },
    {
      ...
      theoryEN: [
        ...
        "Several questions are circuit-building questions, not recall: you will count gates, decide which AND implements the D2 term, and read off the data values for a synthesised function. Work those carefully rather than guessing - write the minterm, count the literals, and check the index.",
      ...
      theoryHI: [
        ...
        "कई सवाल circuit-building हैं, याद नहीं: आप gates गिनेंगे, तय करेंगे कौन सा AND D2 term implement करता है, और एक संश्लेषित function के data मान पढ़ेंगे। उन्हें अंदाज़े के बजाय ध्यान से कीजिए - minterm लिखिए, literals गिनिए, और index जाँचिए।",
  ...
  quiz: [
    ...
    {
      questionEN: "You want to synthesize Y = A xor B using a 4-to-1 MUX with S1=A, S0=B. What values go on D0,D1,D2,D3?",
      ...
      questionHI: "आप S1=A, S0=B वाले 4-to-1 MUX से Y = A xor B संश्लेषित करना चाहते हैं। D0,D1,D2,D3 पर कौन से मान जाते हैं?"
    },
    {
      ...
      answerIndex: 1,
      explainEN: "A 2^n-to-1 MUX (here n=2) realizes any function of n+1 = 3 variables: 2 go to the select lines, the third (and constants) feed the data inputs.",
