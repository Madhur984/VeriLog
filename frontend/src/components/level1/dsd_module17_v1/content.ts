  ...
  "scenes": [
    ...
    },
    {
      ...
      "theoryEN": [
        ...
        "The full subtractor fixes this by being continuous instead of amnesic. It keeps the two original inputs and adds a crucial third one, z, the borrow-in, so it can remember the debt left behind by the previous column. That single extra wire is the entire difference between the two devices.",
