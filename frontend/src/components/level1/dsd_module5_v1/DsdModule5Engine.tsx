    ...
    <div className={`flex h-screen overflow-hidden transition-colors duration-700 relative ${isDarkMode ? 'bg-[#01040c]' : 'bg-white'}`}>
      {isDarkMode && (
        <div className="absolute inset-0 pointer-events-none opacity-[0.18] overflow-hidden z-0">
          ...
          />
          <motion.div
            animate={{ background: `radial-gradient(circle, ${modeColor} 0%, transparent 70%)` }}
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative z-10">
        ...
        <header
          className="border-b flex items-center justify-between px-12 py-4 z-10 gap-6 flex-wrap"
        ...
        >
          <div className="flex flex-col">
            ...
            <h2 className="text-xl font-bold tracking-tight">{page.label[mode]}</h2>
          </div>
