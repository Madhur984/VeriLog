    ...
    <div className="max-w-6xl mx-auto space-y-10 py-4">
      ...
      <div className="grid lg:grid-cols-[1.4fr_1fr] gap-6 items-start">
        ...
        >
          ...
          <div className="absolute top-3 left-3 z-10 px-3 py-1 rounded-full bg-bg-void border border-cyan-400/30 font-mono text-[10px] uppercase tracking-widest text-cyan-300 flex items-center gap-2 pointer-events-none">
