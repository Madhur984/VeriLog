...
const PAGES: Page[] = [
  {
    id: 'intro', part: 'PART I · SIGNAL BASICS', partNum: 1,
    label: 'Introduction to Signals',
    subtitle: 'What a signal is and how it carries information.',
    accentHex: '#06b6d4',
    Component: S01_Introduction,
  },
  {
    id: 'standard', part: 'PART I · SIGNAL BASICS', partNum: 1,
    label: 'Standard Test Signals',
    subtitle: 'Step, ramp, and impulse: the standard test inputs.',
    accentHex: '#10b981',
    Component: S02_StandardSignals,
  },
  {
    id: 'families', part: 'PART II · SIGNAL TYPES', partNum: 2,
    label: 'The Signal Families',
    subtitle: 'Analog vs digital: continuous vs discrete values.',
    accentHex: '#a78bfa',
    Component: S03_AnalogVsDigital,
  },
  {
    id: 'parameters', part: 'PART III · WAVE PROPERTIES', partNum: 3,
        ...
        {PAGES.map((page, idx) => {
          ...
          return (
            <button
              ...
              >
                <div 
                  className={`mt-0.5 w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black border transition-all duration-500 ${isDone || isActive ? 'text-black' : `bg-transparent ${isDarkMode ? 'border-white/10' : 'border-slate-300'} opacity-30`}`}
                  style={{ 
