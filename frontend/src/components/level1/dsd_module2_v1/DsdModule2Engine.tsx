...
const PAGES: Page[] = [
  { id: 'cover',      part: 'PART I · INTRODUCTION',         label: 'The Architect of Logic',       subtitle: 'Cover · meet Madhur, the Hostel Warden.',           Component: S00_Cover },
  { id: 'video',      part: 'PART I · INTRODUCTION',         label: 'The Logic Maze',          subtitle: 'Bilingual lecture · English / हिंदी + transcripts.', Component: S01_VideoLecture },
  { id: 'facts',      part: 'PART I · INTRODUCTION',         label: 'The Facts First',              subtitle: 'Plain-English basics · what a K-map does + an example.', Component: S01b_Facts },
  { id: 'headache',   part: 'PART II · THE PROBLEM',     label: 'The 16-Row Headache',          subtitle: 'Why algebra alone is error-prone for 4 variables.',     Component: S02_TheHeadache },
  ...
  { id: 'manifest',   part: 'PART V · PUTTING IT TOGETHER',    label: 'Today’s Manifest',        subtitle: 'Y = Σm(0,1,2,6,8,10,13,14).',                  Component: S08_Manifest },
  { id: 'operations', part: 'PART V · PUTTING IT TOGETHER',    label: 'Four Operations',              subtitle: 'Corner Suite · Vertical · Pair · VIP.', Component: S09_Operations },
  { id: 'final',      part: 'PART V · PUTTING IT TOGETHER',    label: 'The Final Blueprint',          subtitle: 'Y = B′D′ + CD′ + A′B′C′ + ABC′D.', Component: S10_FinalBlueprint },
